...
<body>
		        ...
		        <div class="row">	        		
		            ...
		            <div class="collapse navbar-collapse">
		                <ul class="nav navbar-nav navbar-right">                 
		                    ...
		                    <li class="no-scroll"><a href="form-3/login.html#">Login</a></li>                
		                    <li class="no-scroll"><a href="form-3/register.html#">Register</a></li>
		                    <li class="no-scroll"><a href="form-3/adminlogin.html#">Admin</a></li>   
	...
	<section id="explore">
		<div class="container">
			...
			<div>
				<a href="table2.php" class="btn btn-primary">View the entire MUSIC CATALOGUE<i class="fa fa-angle-right"></i></a><!--To put link in href-->
			</div>			
		</div>
	</section><!--/#event-->
